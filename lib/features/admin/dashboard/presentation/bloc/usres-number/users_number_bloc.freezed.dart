...
mixin _$UsersNumberState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String number) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String number)? success,
...
class _$SuccessStateImpl implements SuccessState {
  const _$SuccessStateImpl({required this.number});
  ...
  @override
  String toString() {
    return 'UsersNumberState.success(number: $number)';
  }
...
abstract class SuccessState implements UsersNumberState {
  const factory SuccessState({required final String number}) =
      _$SuccessStateImpl;
