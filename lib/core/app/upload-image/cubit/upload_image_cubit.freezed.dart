...
mixin _$UploadImageState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String url) removeImage,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String url)? removeImage,
...
class _$RemoveImageStateImpl implements RemoveImageState {
  const _$RemoveImageStateImpl({required this.url});
  ...
  @override
  String toString() {
    return 'UploadImageState.removeImage(url: $url)';
  }
...
abstract class RemoveImageState implements UploadImageState {
  const factory RemoveImageState({required final String url}) =
